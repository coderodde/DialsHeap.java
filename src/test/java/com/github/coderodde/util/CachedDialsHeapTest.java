...
public final class CachedDialsHeapTest {
    
    private CachedDialsHeap<String> heap; 
    private Iterator<String> iterator;
    
    @Before 
    public void before() {
        heap = new CachedDialsHeap<String>();
        iterator = null;
    }
    ...
    public void testClone() {
        ...
        CachedDialsHeap<String> copy = 
                (CachedDialsHeap<String>) heap.clone();
        ...
        copy = (CachedDialsHeap<String>) heap.clone();
        
        copy.insert("A", 10);
        
        assertEquals("A", copy.extractMinimum());
    }
